...
def animate_line_creation_negative_slope():
    fig, ax = plt.subplots()
    xdata, ydata = [], []
    ln, = plt.plot([], [], 'b-') # 'b-' for blue line
    ...
    def update(frame):
        x = frame
        y = -2 * x + 2 # Apenas mudamos o coeficiente de x para -2
        xdata.append(x)
        ydata.append(y)
...
if __name__ == "__main__":
    animate_line_creation_negative_slope()